<h1 align="center">Criador de Super Herói</h1>
...
Os alunos serão introduzidos a elementos de design, como o botão de rádio (opção), menu suspenso e blocos de código, como showElement, hideElement, setImageURL, e getProperty.
